...
Our lab has been collecting data on the exposure and symptom onset for Wuhan novel coronavirus (nCoV-2019) cases that have been confirmed outside of the Hubei province.
...
We estimate the incubation period using the \texttt{coarseDataTools} package based on the paper by Reich *et al*, 2009, adapting code originally written for determining the incubation period of Zika virus (Lessler *et al*, 2016).
